    ...
    <AppShell>
      <div className="mx-auto grid max-w-2xl gap-5">
        <div>
          ...
          <h1 className="mt-1 text-3xl font-semibold tracking-tight text-ink">Category settings</h1>
          <p className="mt-2 text-sm text-muted">Used categories are archived from the app instead of deleted.</p>
        </div>
        <Card>
